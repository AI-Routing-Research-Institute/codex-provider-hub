...
from claude_local_proxy import create_claude_proxy_app, load_claude_proxy_providers
...
from codex_local_proxy_app import display_path, resolve_user_path
...
def build_claude_server(
    *,
    ...
    router = ProviderRouter(
        providers,
        current_provider_id=preferred_id,
    )
    ...
    def runtime_snapshot() -> dict[str, Any]:
        return {
            ...
            "active_port": port,
            "restart_required": int(settings.get("port", port)) != port,
